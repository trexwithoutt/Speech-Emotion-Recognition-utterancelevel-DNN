...
elmc = ELMClassifier(n_hidden=20, activation_func='hardlim', alpha=0.0, random_state=0)
...
elmr = pipeline.Pipeline([('rhl', RandomLayer(random_state=0, activation_func='hardlim')),
